...
public class RideablevillagerRenderer extends MobRenderer<RideablevillagerEntity, VillagerRenderState, VillagerModel> {
	...
	public RideablevillagerRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(RideablevillagerEntity entity, VillagerRenderState state, float partialTicks) {
